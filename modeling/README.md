...
## Описание данных
Датасет состоит из 40478 снимков размера 256х256 формата .jpg бассейна Амазонки со спутника Planet's Flock 2 станции International Space. Всего на снимках представлено 17 классов явлений, описывающих состояние леса. 
...
0. Загрузка репозитория в свою рабочую директорию при помощи GIT.
```bash
...
Лучшая модель загружена в DVC и будет использована для запуска и деплоя сервиса в данном [репозитории](https://github.com/EugeneRomanov/JMLC_ITMO_2024/tree/main/service).
